                ...
                <div class="card-body">
                    ...
                    <form id="profileForm" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-4">
                            <img id="preview-image" src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('images/default-avatar.png') }}" alt="{{ $user->first_name }}" class="rounded-circle mb-2" width="100" height="100">
                            <div class="mt-2">
