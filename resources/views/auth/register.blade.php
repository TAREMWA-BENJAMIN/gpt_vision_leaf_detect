...
<body>
    <div class="register-container">
        ...
        <div class="register-form" style="max-height: 90vh; overflow-y: auto;">
            ...
            <p class="form-subtitle">Join our plant disease detection platform</p>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-primary btn-register w-100 mb-4">Create Account</button>
